...
# Use a reusable type for money: max 10 digits, 2 decimal places
Money = condecimal(max_digits=10, decimal_places=2)

class FinanceAccountSchema(Schema):
    startingBalance: Money = Field(alias="starting_balance")
    currentBalance: Money = Field(alias="current_balance")
...
class RecurringBillSchema(Schema):
    ...
    amountPaid: Optional[Money] = Field(default=None, alias="amount_paid")
