...
export function useDialogState() {
  ...
  const [savingsDepositDialogOpen, setSavingsDepositDialogOpen] =
    useState(false);
  const [savingsTransferDialogOpen, setSavingsTransferDialogOpen] =
    useState(false);
  const [savingsRecurringDialogOpen, setSavingsRecurringDialogOpen] =
    useState(false);
